...
var pathWhiteList = { // MyPageに遷移したときにundefするJS（ページJSのみおくこと）
	...
	PuellaHistoriaSingleRaid:'js/quest/puellaHistoria/lastBattle/SingleRaid',
	//APIの都合でページURL変更
	//フロント側の名称は PuellaHistoriaGroupRaid
	EventPuellaRaidTop:'js/quest/puellaHistoria/lastBattle/GroupRaid', 
	PuellaHistoriaRouter:'js/quest/puellaHistoria/lastBattle/Router',
	PuellaHistoriaGroupRaidQuestResultMainBoss:'js/quest/puellaHistoria/lastBattle/QuestResultMainBoss',
	PuellaHistoriaGroupRaidQuestResultSubBoss:'js/quest/puellaHistoria/lastBattle/QuestResultSubBoss',
	
	//scene0用ページ
	Scene0Top: 'js/quest/scene0/Top',
	Scene0StorySelectBeforeFilm1: 'js/quest/scene0/StorySelectBeforeFilm1',
	Scene0StorySelectAfterFilm1: 'js/quest/scene0/StorySelectAfterFilm1',
	Scene0BattleSelect: 'js/quest/scene0/BattleSelect',
	Scene0SideStorySelect: 'js/quest/scene0/SideStorySelect',
	...
	//メモリア新イベント
	EventWitchTop: 'js/event/EventWitch/page/Top',
	EventWitchExchangeTop: 'js/event/EventWitch/page/ExchangeTop',
	EventWitchExchangeAnime: 'js/event/EventWitch/page/ExchangeAnime',
	EventWitchIconTest: 'js/test/EventWitchIconTest',

	//ワルプルイベント
	EventWalpurgisRaidTop:'js/event/EventWalpurgis/GroupRaid', 
	EventWalpurgisRaidQuestResultMainBoss:'js/event/EventWalpurgis/QuestResultMainBoss',
	EventWalpurgisRaidQuestResultSubBoss:'js/event/EventWalpurgis/QuestResultSubBoss',
